...
I chose the name {ghee} for a couple reasons. One, my neighbor loves using ghee (clarified butter) to cook with, and I've become a fan. Two, I think it makes it easy to switch between this package and its underlying one, {gh}, if you need to perform sophisticated API requests.
...
![](graphics/ghee/ghee_test_create.png)
...
![](graphics/ghee/ghee_test_mutate_issues.png)
...
![](graphics/ghee/ghee_test_mutate_privacy.png)
...
![](graphics/ghee/ghee_test_mutate_name.png)
